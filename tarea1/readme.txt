...
(Se incluyen 4 imagenes de prueba.)

Escribir en la terminal:

	python3 Filtros.py ó si no funciona escribir python Filtros.py
...
Si la imagen está en la misma carpeta de los archivos Filtros.py y ManejadorImagen.py
